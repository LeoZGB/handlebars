...
templates['render'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                    <li>country ID: "
    + alias4(((helper = (helper = lookupProperty(helpers,"country_id") || (depth0 != null ? lookupProperty(depth0,"country_id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"country_id","hash":{},"data":data,"loc":{"start":{"line":7,"column":36},"end":{"line":7,"column":50}}}) : helper)))
    + " <br> probability: "
